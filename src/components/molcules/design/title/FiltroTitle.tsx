...
const FiltroTitle = ({colorBool}) => {
    return (
        <>
            ...
            >
                <TitleText text="F" exitdelay={0.12} delay={1.22} />
                <TitleText text="I" exitdelay={0.1}  delay={1.2}/>
                <TitleText text="L" exitdelay={0.08} delay={1.18} />
                <TitleText text="T" exitdelay={0.06} delay={1.16} />
                <TitleText text="R" exitdelay={0.04} delay={1.14} />
                <TitleText text="O" exitdelay={0.02} delay={1.12} />
            </TitleWrapper>
        </>
    )
}
